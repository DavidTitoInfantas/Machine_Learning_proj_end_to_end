...
class TestDataIngestion:
    ...
    def ingestion(self, tmp_path, sample_data):
        ...
        config = DataIngestionConfig(
            ...
            #                ),
            train_data_path=os.path.join(tmp_path, "artifacts", "train.csv"),
            test_data_path=os.path.join(tmp_path, "artifacts", "test.csv"),
            raw_data_path=os.path.join(tmp_path, "artifacts", "data.csv"),
        )
